    ...
    <nav
      ...
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        <Link
          ...
          {/* Text wordmark. Swap for an image logo whenever you have one. */}
          <span
            className="text-eerieBlack sm:text-[24px] text-[19px]
            font-bold font-poppins tracking-[1px] whitespace-nowrap">
            Junior Mohyen
          </span>
        </Link>
